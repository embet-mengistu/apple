...
//     fetch(`http://localhost:2004/iphones`)
//       .then((res) => res.json())
//       .then((data) => setiphoneProducts(data.products));
//   }, []);
//   let flip = true;
//   return (
//     <div>
//       <section>
//         <div>
//           <h1 className="text-center bold">Iphones</h1>
//           <h1 className="text-center ">The best for the brighest</h1>
//         </div>

//         <div>
//           {iphoneProducts?.map((data) => {
//             let order1 = 1;
//             let order2 = 2;
//             if (flip) {
//               order1 = 2;
...
//               <div>
//                 {/* /////////////////// */}
//                 <div key={data.product_url} className="order-${order1}">
...
//                     <ul>
//                       <li>
//                         <Link to={`/iphone/${data.product_url}`}>
//                           Learn more
//                         </Link>
//                       </li>
//                     </ul>
...
//                 <div className="product-image order-${order2}">
